...
struct BCOVPlayerViewControllerRepresentable: UIViewControllerRepresentable {
    typealias UIViewControllerType = IMAPlayerController

    let playerModel: PlayerModel

    func makeUIViewController(context: Context) -> IMAPlayerController {
        return IMAPlayerController(playerModel)
    }

    func updateUIViewController(_ uiViewController: IMAPlayerController, context: Context) {
        // No updates needed
    }
}
