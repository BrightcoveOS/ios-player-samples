...
NSString * const kGoogleDAISourceId = @"2528370";
NSString * const kGoogleDAIVideoId = @"tears-of-steel";
NSString * const kGoogleDAIAssetKey = @"sN_IYUG8STe1ZzhIIE_ksA";
  ...
  didReceiveLifecycleEvent:(BCOVPlaybackSessionLifecycleEvent *)lifecycleEvent
{
    ...
    if ([kBCOVDAILifecycleEventAdsLoaderLoaded isEqualToString:lifecycleEvent.eventType])
    {
        NSLog(@"ViewController - Ads loaded.");

        IMAAdsManager *adsManager = lifecycleEvent.properties[kBCOVDAILifecycleEventPropertyKeyAdsManager];
        if (adsManager)
        {
    ...
    else if ([kBCOVDAILifecycleEventAdsManagerDidReceiveAdEvent isEqualToString:lifecycleEvent.eventType])
    {
...
#pragma mark - BCOVDAIPlaybackSessionDelegate
...
- (void)willCallIMAAdsLoaderRequestAdsWithRequest:(IMAStreamRequest *)adsRequest
{
    ...
    NSLog(@"ViewController - IMAStreamRequest.adTagParameters %@", adsRequest.adTagParameters);
}
